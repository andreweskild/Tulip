...
Item {
     ...
     */
     property url source: {
        return name ? name.indexOf("/") === 0 || name.indexOf("file://") === 0 || name.indexOf("qrc") === 0
                      ? name : "image://tulipicontheme/" + name
                    : "";
    }
    ...
    */
    ...
    property bool colorize: (String(icon.source).indexOf(".color.") === -1 &&
                             String(icon.source).indexOf("image://tulipicontheme/") === -1) ||
    ...
    /*!
        ...
        Source image size.
    */
    readonly property real sourceSize: String(icon.source).indexOf("image://tulipicontheme/") === 0 ? Units.roundToIconSize(size) : size
