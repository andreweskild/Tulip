...
/*!
    \qmlmethod color Tulip.Controls::Color::transparent(color color, real alpha)
...
/*!
    \qmlmethod color Tulip.Controls::Color::blend(color color1, color color2, real alpha)
...
/*!
    \qmlmethod real Tulip.Controls::Color::luminance(color color)
...
/*!
    \qmlmethod bool Tulip.Controls::Color::isDarkColor(color color)
...
/*!
    \qmlmethod color Tulip.Controls::Color::lightDark(color background, color lightColor, color darkColor)
